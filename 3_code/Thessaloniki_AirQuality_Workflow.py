...
# -*- coding: utf-8 -*-
"""
Thessaloniki Air Quality Workflow (Scenario 2) — FINAL VERSION

Παράγει:
1. Mapping σταθμών–δημοτικών κοινοτήτων
2. Συνολικούς μέσους όρους (2010–2013)
3. Υπολογισμό ρύπων ανά κάτοικο
4. Έλεγχο υπέρβασης ΠΟΥ/ΕΕ
5. Excel (μόνο Mapping + Συνολικοί Μέσοι & Ανά Κάτοικο)
6. Γραφήματα ανά ρύπο (by_district)
7. Ενιαίο γράφημα συνολικής επιβάρυνσης ανά κάτοικο (Total_Pollutants_per_Capita.png)
...
def plot_total_pollution_per_capita(df, outdir):
    """
    Ενιαίο γράφημα που δείχνει το συνολικό φορτίο ρύπων ανά κάτοικο ανά διαμέρισμα.
    Υπολογίζει το άθροισμα όλων των ρύπων ανά κάτοικο.
    """
    ...
    plt.figure(figsize=(10,6))
    bars = plt.bar(total_per_district["Δημοτική Κοινότητα"], total_per_district["Ρύποι ανά κάτοικο"],
...
def main():
    ...
    # Εξαγωγή Excel (μόνο Mapping + Συνολικοί Μέσοι & Ανά Κάτοικο)
    ...
    plot_total_pollution_per_capita(overall_means, output_dir)
